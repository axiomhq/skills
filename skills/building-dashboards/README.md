...
- **APL + Metrics/MPL Patterns** - Golden signals, percentiles, error rates, and metrics chart payloads (`metricsFilter` / `metricsTransformations`)
...
- `query-metrics` skill (for metrics dataset/metric/tag discovery when building metrics charts)
- Tools: `jq`, `curl`
...
- `query-metrics` - Discover metric names, tags, and tag values for metrics/MPL chart payloads
